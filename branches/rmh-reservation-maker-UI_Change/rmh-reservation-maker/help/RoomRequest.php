...
<html>
    ...
    <head>
        ...
        <title>Requesting a Room</title>
        <br/><br/>
    </head>
    <body>
        <div align ="center"><h1><strong>Requesting a Room</h1><br/>
            <ol>
    ...
    <input type="submit" class="helpbutton" value="Back" align="bottom" onclick="location.href='../family/profileDetail.php'" />
        </div>
        </div>
</html>
