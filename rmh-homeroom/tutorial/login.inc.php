...
<html>
	...
	<body>
		...
		<p>If you are <i>requesting a room</i> at the House, you can sign in with the Username <strong>guest</strong> and no Password.
		Once you sign in you will be able to fill out and submit a <b>room request></b> form on-line.
			...
			<ul><li>For example, if your first name is John and your phone number is (207)-123-4567, your Username would be <strong>John2071234567</strong>.
				...
				<li>If all else fails, or if you do not remember your password, please contact the <a href="mailto:housemngr@rmhportland.org">House Manager</a>.
			</ul>
<p> Remember to <strong>logout</strong> when you are finished using RMH Homebase.
	</body>
</html>
